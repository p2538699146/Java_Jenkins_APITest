package yi.master.test.common.mail;
...
public class EmailTest {
	public static void main(String[] args) {
		...
		mailInfo.setUsername("xuwangcheng14@163.com");
		mailInfo.setPassword("Xuwangcheng14");// 您的邮箱密码
		mailInfo.setFromAddress("xuwch_dcits@163.com");
		mailInfo.setToAddress("xuwangcheng14@163.com");
		mailInfo.setSubject("设置邮箱标题");
				
		//附件
		String[] attachFileNames={"d:/BugReport.txt"};
