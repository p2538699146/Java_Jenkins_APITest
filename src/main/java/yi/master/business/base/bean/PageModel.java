...
public class PageModel<T> {
	 ...
	 * 当前展示的所有字段名
	 */
	private List<List<String>> dataParams = new ArrayList<List<String>>();
	...
	public PageModel(String orderDataName, String orderType,
			String searchValue, List<List<String>> dataParams, int dataNo,
			int pageSize) {
		super();
	...
	public List<List<String>> getDataParams() {
		return dataParams;
	}


	public void setDataParams(List<List<String>> dataParams) {
		this.dataParams = dataParams;
	}
