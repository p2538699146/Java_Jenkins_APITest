...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='测试环境信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='复杂参数组成';
...
CREATE TABLE IF NOT EXISTS `at_complex_scene` (
  ...
  `mark` text COLLATE utf8mb4_unicode_ci COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='测试集中的组合场景';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='全局变量表\r\n目前可使用的场景(有key值)：\r\n1、所有字段的测试数据\r\n2、请求地址(报文中的mock/real/接口中定义的/测试集运行时配置中配置的自定义请求地址)\r\n3、接口参数中的默认值\r\n4、定时任务中的Cron表达式\r\n5、关联验证中验证值\r\n6、节点验证中验证值(取值方式为字符串、数据库时均有效)\r\n7、全文验证中验证报文\r\n 8、UUID';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='接口信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='接口mock信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='接口探测信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户操作记录信息表';

-- 正在导出表  atp.at_log_record 的数据：~0 rows (大约)
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='接口下的报文格式信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='接口自动化测试场景';
...
) ENGINE=InnoDB AUTO_INCREMENT=1132 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='操作接口信息';
...
INSERT INTO `at_operation_interface` (`op_id`, `op_name`, `call_name`, `is_parent`, `op_type`, `mark`, `status`, `parent_op_id`) VALUES
	...
	(119, '获取所有操作接口', 'role-getNodes', 'false', NULL, '获取当前所有操作接口，并标记哪些是当前角色拥有的', '0', 21),
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='接口性能测试配置';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='性能测试结果详情';
...
CREATE TABLE IF NOT EXISTS `at_role` (
  ...
  `mark` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT ' 备注',
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='角色信息';
...
INSERT INTO `at_role` (`role_id`, `role_group`, `role_name`, `mark`) VALUES
	(1, '性能测试组', 'admin', 'admin'),
	(3, '普通用户组', 'default', '默认组,不能删除'),
	(5, '自动化测试组', 'tester', '接口自动化测试组');
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='接口自动化测试配置';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='所属测试场景的测试数据';
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT=' 测试报告';
...
) ENGINE=InnoDB AUTO_INCREMENT=361 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8 COMMENT='测试详情结果';
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='测试集';
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户信息';

-- 正在导出表  atp.at_user 的数据：~0 rows (大约)
DELETE FROM `at_user`;
...
INSERT INTO `at_user` (`user_id`, `username`, `real_name`, `password`, `login_identification`, `role_id`, `create_time`, `status`, `last_login_time`, `if_new`) VALUES
	(1, 'admin', '超级管理员', '6de56f9aad7db084b730f719d0874175', 'a708416d8ad5adefe443ecb5dc187311', 1, '2016-09-18 14:36:06', '0', '2018-10-31 05:38:54', 'atp');
...
) ENGINE=InnoDB AUTO_INCREMENT=91 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户邮件信息';
...
-- 正在导出表  atp.at_web_test_element 的数据：~0 rows (大约)
